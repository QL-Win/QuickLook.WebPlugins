 ...
 * Renders the reStructuredText section tree and fires callbacks on entry click.
 */

import type { RstToc, RstTocEntry } from './lib/types.js';
...
function buildItemWithPath(entry: RstTocEntry, onNavigate: NavigateCallback): HTMLLIElement {

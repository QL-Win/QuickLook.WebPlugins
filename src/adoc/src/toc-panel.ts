 ...
 * Renders the AsciiDoc section tree and fires callbacks on entry click.
 */

import type { AdocToc, AdocTocEntry } from './lib/types.js';
...
function buildItemWithPath(entry: AdocTocEntry, onNavigate: NavigateCallback): HTMLLIElement {
